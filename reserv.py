...
class ChatWindow(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.setFixedSize(600, 800)  # Изменен размер окна
        ...
        self.layout.addWidget(self.chat_history, 4)  # Увеличен размер поля вывода
        ...
        self.input_box.setFixedHeight(60)  # Установлен фиксированный размер поля ввода
        self.layout.addWidget(self.input_box, 1)  # Уменьшен размер поля ввода
...
if __name__ == '__main__':
    openai.api_key = "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"  # Ваш API-ключ OpenAI
